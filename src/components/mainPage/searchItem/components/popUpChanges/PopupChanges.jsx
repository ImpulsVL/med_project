...
import './PopupChanges.scss';

function PopupChanges({code, name}) {
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append('diagnosisName', name);
        ...
        try {
            const response = await fetch(`${env.REACT_APP_APP_API_PROTOCOL}://${env.REACT_APP_DOMEN_NAME}/api/sendChangeDiagnos`, {
                method: 'POST',
                body: formData,
            });
    ...
    return (
        <div>
            <button className='button prpl' onClick={togglePopUp}>
                        ...
                        <form className='form_popup' onSubmit={handleSubmit}>
                            ...
                            <div className='form-double'>
                                <div className='form'>
                                    ...
                                    <input
                                        className={`input-popup-double-spec ${errorInput1 ? 'input-error' : ''}`}
                                        type='text'
                                ...
                                <div className='form'>
                                    ...
                                    <input
                                        className={`input-popup-double-spec ${errorInput3 ? 'input-error' : ''}`}
                                        type='text'
